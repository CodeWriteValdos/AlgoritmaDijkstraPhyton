...
root = Tk()
root.title('Tb 2 Algoritma')

frm = Frame(root, padx=10, height=120)
Label(frm, text="Muhamad Rivaldi -- 41519110184", font='bold').pack()
Label(frm, text="Universitas Mercubuana", font='bold').pack()

frm.pack(expand=FALSE, fill=NONE)

frm2 = LabelFrame(root, text='Algorima Dijkstra ', bd=8, bg='white')

image = PhotoImage(file="tb2image.png")
